...
<head>
    ...
    <title>Part 4: Jojo's Bizzare Adventures</title>
    <link rel="stylesheet" href="../css/part4_style.css">
</head>
    ...
    <div class="page_container">
        ...
        <header>
            ...
            <div class="nav_stripe">
                <div class="category_text"><p>Diamond is Unbreakable</p></div>
        ...
        <main>
            <div id="pb_banner">
                <div id="pb_banner__left">
                    <img src="../immagini/diu_banner.jpg" alt="">
                    <img src="../immagini/fade_h.png" alt="">
                </div>
                <div id="pb_banner__right">
                    <img src="../immagini/diu_logo.png" alt="">
            ...
            <div id="plot">
                <h2>Una tranquilla città, all'apparenza...</h2>
                
                <p>Seguono le avventure di Josuke Higashikata, figlio illegittimo di Joseph. Lui e i suoi amici vanno a caccia di un arco e di una freccia miracolosi.</p>
                <p>Si sradicano la vite precedentemente tranquille dei cittadini di Morioh Cho.</p>
            </div>

            <div id="tv">
                <div id="tv__img">
                    <img src="../immagini/tv.webp" alt="">
                    <video src="../video/Jojo's Bizarre Adventure Part 4 Diamond is Unbreakable FULL HD PV trailer.mp4" controls></video>
                </div>
            </div>
